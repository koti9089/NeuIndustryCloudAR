...
namespace SampleXamarin
{
    ...
    public class AnchorVisual
    {
        ...
        public AnchorVisual(ArFragment arFragment, Anchor localAnchor)
        {
            ...
            transformableTextNode.TranslationController.TransformableNode.LocalPosition = new Vector3(0.0f, 0.7f, 0.3f);
            ...
            //SetModelColor(this.fragment.Context, Android.Graphics.Color.Red);
            //SetModelColor(this.fragment.Context, Android.Graphics.Color.Green);
            //SetModelColor(this.fragment.Context, 16760576);
